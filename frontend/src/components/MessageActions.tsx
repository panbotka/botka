...
import { EyeOff, Eye, GitFork } from 'lucide-react';
...
export default function MessageActions({ role, content, isLastAssistant, isHidden, onEdit, onRegenerate, onBranch, onFork, onHide }: Props) {
